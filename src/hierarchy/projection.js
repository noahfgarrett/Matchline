...
export function resolveRecordContext(record,profile){
  ...
  const discipline=overrideValues.discipline||assign.values.discipline||(record.isInstrument?clean(h.disciplineFallbacks.instrument):clean(h.disciplineFallbacks.default))||'Unassigned Discipline';
  const system=overrideValues.system||assign.values.system||record.systemHint||clean(h.systemFallbacks[discipline])||clean(h.systemFallbacks.default)||'Unassigned System';
  ...
  explicit.discipline=!!assign.values.discipline||record.isInstrument;
  explicit.system=!!assign.values.system||isSystemName(record.tag);
